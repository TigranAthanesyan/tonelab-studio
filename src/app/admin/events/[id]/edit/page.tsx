    ...
    try {
      ...
      if (data.success) {
        ...
        if (eventData.videoUrl) {
          setVideoPreview(eventData.videoUrl);
        }
      } else {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (eventData.success) {
        ...
        setError(eventData.error || 'Failed to update event');
      }
    } catch (err) {
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.formGroup}>
            <label htmlFor="image" className={styles.label}>
              Event Poster {imagePreview && '(Change Image)'}
            </label>
            <input
              type="file"
              id="image"
          ...
          <div className={styles.formGroup}>
            <label htmlFor="video" className={styles.label}>
              Event Video {videoPreview && '(Change Video)'} (Optional)
            </label>
            <input
              type="file"
              id="video"
